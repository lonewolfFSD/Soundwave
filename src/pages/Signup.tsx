      ...
      <div className="w-[420px] md:w-full max-w-4xl relative z-10">
        <div className="backdrop-blur-xl bg-black/40 border border-white/20 rounded-2xl overflow-hidden shadow-2xl shadow-black/50 animate-fade-in-up-scale">
          <div className="flex flex-col md:flex-row h-full">
            {/* Left: Image section - hidden on mobile, shown on md+ */}
            <div className="hidden md:block md:w-1/2 relative overflow-hidden">
              <div className="absolute inset-0 bg-black/50"></div> {/* Slightly darker overlay for better text readability */}
              <img
                src={Background}
              ...
              <div className="absolute inset-0 flex flex-col items-start justify-end p-8 md:p-12">
                <h2 className="text-4xl  font-black text-white/90 tracking-tight drop-shadow-2xl animate-pulse-slow" style={{
                  fontFamily: "Cabin"
                }}>
                  SoundWave
                </h2>
                <p className="mt-3 text-md text-white/70 font-light max-w-xs drop-shadow-md" style={{
                  fontFamily: "Space Grotesk, sans-serif"
                }}>
                  Discover, stream, and feel the rhythm of tomorrow's music.
                </p>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2 px-8 py-14 md:py-8  rounded-r-2xl border-t border-r border-b border-white/10 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <div className="md:hidden text-center mb-8">
                <h1 className="text-4xl font-extrabold text-white tracking-tight animate-pulse-slow" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                  SoundWave
                </h1>
              ...
              <div className="hidden md:block mb-6">
                <h1 className="text-4xl font-extrabold text-white tracking-tight animate-pulse-slow" style={{
                  fontFamily: "Cabin"
                }}>
                  SoundWave
                </h1>
                <p className="mt-3 text-gray-400 font-medium" style={{
                  fontFamily: "Space Grotesk, sans-serif"
                }}>
                  Join the music revolution
                </p>
